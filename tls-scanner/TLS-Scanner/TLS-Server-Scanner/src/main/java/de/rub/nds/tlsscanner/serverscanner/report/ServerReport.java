...
public class ServerReport extends ScanReport {
    ...
    private Boolean speaksDtlsDraft = null;
    ...
    public Boolean getSpeaksDtlsDraft() {
        return speaksDtlsDraft;
    }

    public void setSpeaksDtlsDraft(Boolean speaksDtlsDraft) {
        this.speaksDtlsDraft = speaksDtlsDraft;
    }
