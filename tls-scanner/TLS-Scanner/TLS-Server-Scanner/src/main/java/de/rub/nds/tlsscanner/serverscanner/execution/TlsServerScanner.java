...
public final class TlsServerScanner extends TlsScanner {
    ...
    protected void fillProbeLists() {
        ...
        if (config.getDtlsDelegate().isDTLS()) {
            ...
            // addProbeToProbeList(new DtlsIpAddressInCookieProbe(configSelector, parallelExecutor), true);
    ...
    public ServerReport scan() {
        ...
        try {
            ...
            serverReport.setSpeaksDtlsDraft(configSelector.isSpeaksDtlsDraft());
