...
public class Pkcs1VectorGenerator {
     ...
     */
    public static List<Pkcs1Vector> generatePkcs1Vectors(RSAPublicKey publicKey, BleichenbacherScanType type,
     ...
     * @return                    pkcs1Vectors
     */
    public static List<Pkcs1Vector> generatePlainPkcs1Vectors(int publicKeyBitLength, BleichenbacherScanType type,
        ProtocolVersion protocolVersion) {
