...
public class CipherSuiteResult extends ProbeResult<ServerReport> {
    ...
    private TestResult supportsOnlyPsk = TestResults.FALSE;
    ...
    public void mergeData(ServerReport report) {
        if (pairLists != null) {
            ...
            supportsOnlyPsk = TestResults.TRUE;
            ...
            for (VersionSuiteListPair pair : pairLists) {
                ...
                for (CipherSuite suite : pair.getCipherSuiteList()) {
                    ...
                    if (!suite.isPsk()) {
                        supportsOnlyPsk = TestResults.FALSE;
                    }
                }
            }
            ...
            supportsOnlyPsk = TestResults.COULD_NOT_TEST;
        }
    ...
    private void writeToReport(ServerReport report) {
        report.putResult(TlsAnalyzedProperty.SUPPORTS_ONLY_PSK, supportsOnlyPsk);
