...
public class PaddingOracleAttacker {
    ...
    public PaddingOracleAttacker(Config baseConfig, ParallelExecutor executor,
        PaddingRecordGeneratorType recordGeneratorType, PaddingVectorGeneratorType vectorGeneratorType,
