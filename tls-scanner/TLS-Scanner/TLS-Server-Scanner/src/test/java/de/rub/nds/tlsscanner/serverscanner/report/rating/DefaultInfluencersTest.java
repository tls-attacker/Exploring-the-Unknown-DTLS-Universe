    ...
    public void createDefaultRatingInfluencers() throws IOException, JAXBException {
        ...
        influencers.add(new RatingInfluencer(TlsAnalyzedProperty.SUPPORTS_CLIENT_SIDE_INSECURE_RENEGOTIATION,
            new PropertyResultRatingInfluencer(TestResults.TRUE,
                TlsAnalyzedProperty.VULNERABLE_TO_RENEGOTIATION_ATTACK_EXTENSION_V1, TestResults.TRUE),
            new PropertyResultRatingInfluencer(TestResults.FALSE, 50)));
        influencers.add(new RatingInfluencer(TlsAnalyzedProperty.SUPPORTS_CLIENT_SIDE_INSECURE_RENEGOTIATION,
            new PropertyResultRatingInfluencer(TestResults.TRUE,
                TlsAnalyzedProperty.VULNERABLE_TO_RENEGOTIATION_ATTACK_EXTENSION_V2, TestResults.TRUE),
            new PropertyResultRatingInfluencer(TestResults.FALSE, 50)));
        ...
        influencers.add(new RatingInfluencer(TlsAnalyzedProperty.SUPPORTS_CLIENT_SIDE_INSECURE_RENEGOTIATION,
            new PropertyResultRatingInfluencer(TestResults.TRUE,
                TlsAnalyzedProperty.VULNERABLE_TO_RENEGOTIATION_ATTACK_CIPHERSUITE_V1, TestResults.TRUE),
            new PropertyResultRatingInfluencer(TestResults.FALSE, 50)));
        influencers.add(new RatingInfluencer(TlsAnalyzedProperty.SUPPORTS_CLIENT_SIDE_INSECURE_RENEGOTIATION,
            new PropertyResultRatingInfluencer(TestResults.TRUE,
                TlsAnalyzedProperty.VULNERABLE_TO_RENEGOTIATION_ATTACK_CIPHERSUITE_V2, TestResults.TRUE),
            new PropertyResultRatingInfluencer(TestResults.FALSE, 50)));
        ...
        influencers.add(new RatingInfluencer(
            TlsAnalyzedProperty.SUPPORTS_TLS_COMPRESSION, new PropertyResultRatingInfluencer(TestResults.TRUE,
                TlsAnalyzedProperty.VULNERABLE_TO_CRIME, TestResults.TRUE),
            new PropertyResultRatingInfluencer(TestResults.FALSE, 100)));
        ...
        influencers.add(new RatingInfluencer(TlsAnalyzedProperty.SUPPORTS_HPKP_REPORTING,
            ...
            new PropertyResultRatingInfluencer(TestResults.FALSE, 0)));
        influencers.add(new RatingInfluencer(
            TlsAnalyzedProperty.SUPPORTS_HTTP_COMPRESSION, new PropertyResultRatingInfluencer(TestResults.TRUE,
                TlsAnalyzedProperty.VULNERABLE_TO_BREACH, TestResults.TRUE),
            new PropertyResultRatingInfluencer(TestResults.FALSE, 0)));
