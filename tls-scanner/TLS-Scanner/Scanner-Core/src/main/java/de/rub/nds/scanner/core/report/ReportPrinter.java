...
public abstract class ReportPrinter<Report extends ScanReport> {
    ...
    public ReportPrinter(ScannerDetail detail, PrintingScheme scheme, boolean printColorful, Report scanReport) {
        this.detail = detail;
        this.scheme = scheme;
    ...
    protected StringBuilder prettyAppend(StringBuilder builder, String name, Boolean value, AnsiColor color) {
        return prettyAppend(builder, name, "" + value, color);
    }

    protected StringBuilder prettyAppend(StringBuilder builder, String name, String value, AnsiColor color) {
        builder.append(addIndentations(name)).append(": ");
        if (printColorful) {
            builder.append(color.getCode());
        }
    ...
    protected StringBuilder prettyAppendUnderlined(StringBuilder builder, String name, String value) {
    ...
    protected StringBuilder prettyAppendUnderlined(StringBuilder builder, String name, boolean value) {
        return builder.append(addIndentations(name)).append(": ")
            .append((printColorful ? AnsiColor.UNDERLINE.getCode() + value + AnsiColor.RESET.getCode() : value))
            .append("\n");
    }
